    ...
    render() {
        return (
            <div className="largeTile">
                ...
                {this.props.error ? <h1>ERROR</h1> : (this.props.alreadySearched && this.props.mode == "point" && !this.props.loading) || (this.props.alreadySearched && this.props.mode == "search" && !this.props.loading) ?  <LargeInfo alreadySearched={this.props.alreadySearched} data={this.props.data} /> :
                     !this.props.alreadySearched && this.props.mode =="point" && !this.props.loading ?
                        ...
                        </div> : this.props.loading && !this.props.error ? <img src={loader} className="largeTile__loader"></img> : null}
